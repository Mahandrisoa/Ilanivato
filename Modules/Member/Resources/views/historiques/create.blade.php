...
@section('section_center')
    <div class="box">
        ...
        <div class="box-body">
            {{ Form::open(array('route' => 'histories.store','method'=> 'post','files' => true)) }}
            {{ csrf_field() }}
            <div class="form-group row">
                <label class="col-sm-8 form-control-label">Date</label>
                <div class="col-sm-4 has-feedback">
                    <input type="number" min="1878" name="date" class="form-control has-feedback-left">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 form-control-label">Zava-nisy</label>
                <div class="col-sm-10">
