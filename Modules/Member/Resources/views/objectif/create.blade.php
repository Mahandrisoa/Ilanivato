...
@section('section_center')
    <div class="box">
        ...
        <div class="box-body">
            {{ Form::open(array('route' => 'objectifs.store','method'=> 'post')) }}
            {{ csrf_field() }}
            <div class="form-group row">
                <label class="col-sm-2 form-control-label">Tanjona</label>
                <div class="col-sm-10">
                    <textarea name="intitule" rows="2" class="form-control">
                        </textarea>
                </div>
            </div>
            <div class="form-group row">
