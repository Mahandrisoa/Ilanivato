...
@section('content')
    <div class="col-md-9">
        <div>
            <ol class="breadcrumb">
                <li><a href="#">FIANGONANA MITORY</a></li>
                <li><a href="#">Fiheverana ny maha olona</a></li>
                <li class="active">Asa vavolombelona</li>
            </ol>
        </div>
        <h2 class="title" style="margin-top: 40px;margin-bottom: 40px;">Asa vavolombelona</h2>
